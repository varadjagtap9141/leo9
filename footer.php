      ...
      <div class="container py-5">
          <div class="row">
              <div class="col-md-4 text-center p-2">
                  ...
                  <h5 class="txt__color fw-bold">hq@leo9advt.com</h5>
                  <h5 class="txt__color fw-bold">business@leo9advt.com</h5>
              </div>
              <div class="col-md-4 text-center p-2">
                  <p class="fs-5 fw-semibold">Phone:</p>
                  <h5 class="txt__color fw-bold">+91 9881159141</h5>
              </div>
              <div class="col-md-4 text-center p-2">
          ...
          <div class="row">
              <div class="col-md-4 p-2">
                  <a class="navbar-brand" href="#">
                      <img src="https://www.angleadvt.com/leo9/wp-content/uploads/2024/02/01-logo-PNG-White-768x371.png"
          ...
          <hr/ class="text-white">
            <div class="row">
              <div class="col-md-12 text-white text-center p-2">
                  <p class=" fw-semibold">© Copyright 2025. Leo9 Angle Advertising : All Rights Reserved.</p>
              </div>
          </div>
      </div>
  </footer>

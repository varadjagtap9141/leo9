                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="address" id=""><?=$vendor_row['address']?></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-select" id="type" name="type" required>
                                    ...
                                    <option value="Production" <?=($vendor_row['type']=='Production') ? 'selected' : ''?>>Production</option>
                                    <option value="Publication" <?=($vendor_row['type']=='Publication') ? 'selected' : ''?>>Publication</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="city" name="city" placeholder="" value="<?=$vendor_row['city']?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="ifsc" name="ifsc" placeholder="" value="<?=$vendor_row['ifsc']?>" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-select" id="status" name="status" required>
                                    ...
                                    <option value="active" <?=($vendor_row['status']=='active') ? 'selected' : ''?>>Active</option>
                                    <option value="inactive" <?=($vendor_row['status']=='inactive') ? 'selected' : ''?>>Inactive</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">

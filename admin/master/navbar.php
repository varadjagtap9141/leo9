    ...
    <div class="layout-wrapper layout-content-navbar">
        <div class="layout-container">
                ...
                <div class="app-brand demo">
                    <a href="dashboard.php" class="app-brand-link">
                        <span class="app-brand-logo demo">
                            <img width="auto" height="40" src="../components/uploads/<?=$profile_row['favicon']?>"
                                alt="">
                        </span>
            ...
            <div class="layout-page">
                ...
                <nav class="layout-navbar container-md navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme"
                    id="layout-navbar">
